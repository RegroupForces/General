...
def list_to_number(lst: list) -> int:
    ...
    also:
    8*10^3 + 5*10^2 + 3*10^1 + 1*10^0, and this code breaks the list into this format and calculate it.
...
if __name__ == "__main__":
    """This is testcases, assuming all intergers in lst are positive."""
